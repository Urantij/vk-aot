...
public class DateTimeToStringFormatConverter : Newtonsoft.Json.JsonConverter
{
	...
	/// <inheritdoc />
	public DateTimeToStringFormatConverter(string format) => _format = format;

	/// <inheritdoc />
	public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
	{
		var date = value is DateTime time
			? time
			: new();
	...
	/// <inheritdoc />
	public override bool CanConvert(Type objectType) => objectType.IsValueType || objectType == typeof(DateTime);
}